...
//p  Cxu  Cyv, where p is film position (bottom left corner ofthe screen), u is horizontal vector, v is vertical vector, and C is the vec2 obtained byCell Center(pixel index); see camera.h.
